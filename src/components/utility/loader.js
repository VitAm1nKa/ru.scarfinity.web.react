...
class Controller extends React.Component {
    render() {
        if(this.props.show == true)
            return(
                <div className={`overlay-loader${this.props.show ? ' loading' : ''}`}>
                    <svg  className="overlay-loader__icon" version="1.1" role="img" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px">
